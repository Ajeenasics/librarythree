  ...
  return (
    <div className='editprofilebg'>
      ...
      <div className='editprofileborder'>
        ...
        <input className='form-control mb-2 ' name='studentname' placeholder={value.studentname} onChange={(e) => setStudentname(e.target.value)} type='text'></input>
        <label className='editprofilelabel'>Number</label>
        <input className='form-control mb-2' name='studentnumber'placeholder={value.studentnumber} onChange={(e) => setStudentnumber(e.target.value)} type='number'></input>
